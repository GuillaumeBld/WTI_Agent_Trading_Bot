...
from agent_interfaces import (
    TradingSignal, MarketData, SentimentResult,
...
class TestSentimentResult(unittest.TestCase):
    ...
    def test_sentiment_result_creation(self):
        ...
        result = SentimentResult(
            ...
            sentiment_score=0.8,
            confidence=0.9,
            text_snippet="Positive news about Bitcoin adoption."
        )
        self.assertEqual(result.source, "news")
        self.assertEqual(result.sentiment_score, 0.8)
        self.assertEqual(result.confidence, 0.9)
        self.assertEqual(result.text_snippet, "Positive news about Bitcoin adoption.")
